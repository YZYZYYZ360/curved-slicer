...
| R15 | 任何可视化产物（PLY / STL / PNG / HTML / SVG / heatmap / 3D 截图）生成后**必须停下显式告诉用户文件路径并请他打开查看**，得到确认才能进下一步。不准"已生成 X，进入下一步"一笔带过。本红线**同时约束 CLI #1 和 Codex** | 用户 2026-05-17 明示 + 防几何错误传到下游 |
...
| v1.1 | 2026-05-17 | 新增 R15：可视化产物必须停下让用户查看（共同约束 CLI #1 和 Codex）|
